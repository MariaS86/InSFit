<link rel="stylesheet" href="css/formreg.css" id="theme-link" >
...
<head>
    ...
    <link rel="stylesheet" href="css/formreg.css" id="theme-link" >
    <link rel="stylesheet" href="css/fut.css" id="theme-link" >
    <link rel="stylesheet" href="css/head.css" id="theme-link" >
            ...
            <div class="container">
                <div class="header_body">
                    ...
                    <nav class="header_menu">
						...
						<!--	 <li><a href="#" class="header_link">Рецепты</a></li>-->
                <!-- <li><a hr!ef="#" class="header_link">Марафоны</a></li> -->
